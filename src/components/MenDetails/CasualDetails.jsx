...
//       <div className='flex items-center text-!white justify-center gap-2 md:gap-5 mt-23'>
//         <Link to={'/'}>
//           {' '}
//           <span className='text-sm md:text-lg text-white'>Home</span>{' '}
//         </Link>
//         <FaChevronRight className='text-white w-2' />
//         <Link to={'/jalabiya'} className='text-white text-sm md:text-lg'>
//           Jalabiya
//         </Link>
//         <FaChevronRight className='text-white w-2' />
...
//                 Select Size
//                 {selectedSize && (
//                   <span className='ml-2 text-yellow-400 font-normal'>({selectedSize})</span>
//                 )}
//               </p>
//             </div>
...
//             <button onClick={() => setShowSizeChart(true)} className='flex items-center mt-2'>
//               <img src={sizechart} alt='Size Guide' className='w-40 h-12 object-contain' />
//             </button>
//           </div>
...
//             <div className='bg-white rounded-2xl p-5 max-w-3xl w-full relative'>
//               <button
...
//               <img src={sizechart} alt='Size Chart' className='w-full rounded-xl' />
//             </div>
//           </div>
//         )}
//       </div>
