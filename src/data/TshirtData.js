...
import hotlineheavyweightteebrownbv from '../assets/images/MEN/T-Shirt/hotlineheavyweightteebrownbv.jpg';
...
export const TshirtDatas = [
...

  {
    ...
    description:
      'The Crystallized Tanktop is a statement sleeveless piece featuring distinctive studded detailing across a clean white base. Its streamlined silhouette works effortlessly as a standalone piece or as part of a layered casual look.',

    features: [
      'Sleeveless tank-top silhouette',
      'Decorative crystallized and studded detailing',
      'Clean white finish',
      'Streamlined neckline',
      'Suitable for standalone or layered styling',
    ],

    care: [
      'Hand wash or use a gentle cold wash',
      'Turn inside out before washing',
      'Use mild detergent',
      'Do not bleach',
      'Do not wring or twist',
      'Lay flat or hang to air dry',
      'Keep away from rough surfaces that may catch the embellishments',
      'Iron on low heat from the reverse side if necessary',
      'Do not iron directly over embellishments',
    ],
  },
...
export const sizeCharts = {
  ...
  'hotline-heavyweight-tee': {
    title: 'Hotline Heavyweight Crop Tee Size Guide',
  ...
  'same faces collared button-up shirt': {
    title: 'Same Faces Button-Up Shirt Size Guide',
  ...
  'crown-tshirt': {
    title: 'Crown Crop T-Shirt Size Guide',
    fit: 'Relaxed Cropped Fit',
    columns: ['Size', 'Chest (in)', 'Shoulder (in)', '3/4 Sleeve (in)', 'Length (in)'],
    rows: [
      ['S', '38-40', '17', '18', '24'],
      ['M', '40-42', '18', '19', '25'],
      ['L', '42-44', '19', '20', '26'],
  ...
  'goodtimes-heavyweight-graphictee': {
    title: 'Good Times Heavyweight Graphic Tee Size Guide',
  ...
  obsidianthermalribbedtank: {
    title: 'Obsidian Thermal Ribbed Tank Size Guide',
  ...
  'black-tanktop': {
    title: 'Essential Black Tanktop Size Guide',
    fit: 'Contoured / Stretch Fit',
    columns: ['Size', 'Chest (in)', 'Length (in)'],
    rows: [
      ['S', '34-36', '25'],
  ...
  'raglan-shirt': {
    title: 'Black & White Raglan Shirt Size Guide',
    fit: 'Relaxed Fit',
    columns: ['Size', 'Chest (in)', 'Sleeve (in)', 'Length (in)'],
    rows: [
      ['S', '38-40', '28', '27'],
      ['M', '40-42', '29', '28'],
      ['L', '42-44', '30', '29'],
  ...
  'oversized-crew-neck-tshirt': {
    title: 'Oversized Crew Neck T-Shirt Size Guide',
    fit: 'Relaxed Oversized Fit',
    columns: ['Size', 'Chest (in)', 'Shoulder (in)', 'Length (in)'],
    rows: [
      ['S', '40-42', '18', '27'],
