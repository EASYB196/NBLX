...
import { agbadaDatas } from '../../../data/AgbadaData';
    ...
    <div className='md:px-5'>
      <Link to={`/agbada/${product.id}`}>
        ...
        >
          ...
          <h3 className='text-sm font-semibold  text-black px-1 bg-red-400 rounded-xl w-13 text-center relative bottom-118 left-2'>NEW</h3>
  ...
  return (
    <div className='bg-white mt-23 z-10 pt-10'>
      <div className='space-y-7'>
        <h1 className='text-black text-5xl text-center '>Agbada</h1>
        <div className='flex items-center justify-center gap-5'>
          <Link to={'/'} className='text-black'>Home</Link> <FaChevronRight className='text-black w-2' /> <span className='text-black'>Agbada</span>
        </div>
      </div>
