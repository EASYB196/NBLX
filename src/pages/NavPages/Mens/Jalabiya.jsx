    ...
    <div className='md:px-5 font-serif'>
      <Link to={`/jalabiya/${product.id}`}>
        ...
        >
          ...
          <h3 className='text-sm font-semibold  text-black px-1 bg-red-400 rounded-xl w-13 text-center relative bottom-118 left-2 ml-3 md:ml-0'>NEW</h3>
    ...
    <div className='bg-white mt-23 z-10 pt-10'>
      <div className='space-y-7'>
        ...
        <div className='flex items-center justify-center gap-5'>
          <Link to={'/'} className='text-black'>Home</Link> <FaChevronRight className='text-black w-2' /> <span className='text-black'>Jalabiya</span>
        </div>
      </div>
